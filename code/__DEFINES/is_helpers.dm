...
#define islava(A) (istype(A, /turf/simulated/floor/plating/asteroid/lavaland/lava))

#define ischasm(A) (istype(A, /turf/simulated/floor/plating/asteroid/lavaland/chasm))
